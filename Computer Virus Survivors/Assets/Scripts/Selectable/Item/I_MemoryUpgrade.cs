    ...
    protected override void InitExplanation()
    {
        switch (MaxLevel)
        {
            ...
            case 2:
                ...
                goto case 1;
            case 3:
                explanations[2] = "최대 체력 <color=#FF00C7>20</color> 증가";
                goto case 2;
            case 4:
                explanations[3] = "최대 체력 <color=#FF00C7>20</color> 증가";
                goto case 3;
            case 5:
                explanations[4] = "최대 체력 <color=#FF00C7>20</color> 증가";
                goto case 4;
            case 6:
                explanations[5] = "최대 체력 <color=#FF00C7>40</color> 증가";
                goto case 5;
            case 7:
                explanations[6] = "최대 체력 <color=#FF00C7>40</color> 증가";
                goto case 6;
            case 8:
                explanations[7] = "최대 체력 <color=#FF00C7>40</color> 증가";
                goto case 7;
            case 9:
                explanations[8] = "최대 체력 <color=#FF00C7>80</color> 증가";
                goto case 8;
        }
    }
}
