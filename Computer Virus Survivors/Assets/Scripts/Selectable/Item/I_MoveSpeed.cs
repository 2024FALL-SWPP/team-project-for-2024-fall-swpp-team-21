    ...
    protected override void InitExplanation()
    {
        switch (MaxLevel)
        {
            case 1:
                ...
                break;
            case 2:
                explanations[1] = "이동속도 10% 증가";
                goto case 1;
            case 3:
                explanations[2] = "이동속도 10% 증가";
                goto case 2;
            case 4:
                explanations[3] = "이동속도 10% 증가";
                goto case 3;
            case 5:
                explanations[4] = "이동속도 10% 증가";
                goto case 4;
            case 6:
                explanations[5] = "이동속도 10% 증가";
                goto case 5;
            case 7:
                explanations[6] = "이동속도 10% 증가";
                goto case 6;
            case 8:
                explanations[7] = "이동속도 10% 증가";
                goto case 7;
            case 9:
                explanations[8] = "이동속도 20% 증가";
                goto case 8;
        }
    }
}
