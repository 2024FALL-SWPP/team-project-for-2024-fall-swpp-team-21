    ...
    protected override void InitExplanation()
    {
        switch (MaxLevel)
        {
            case 1:
                ...
                break;
            case 2:
                explanations[1] = "회피율 5% 증가";
                goto case 1;
            case 3:
                explanations[2] = "회피율 5% 증가";
                goto case 2;
            case 4:
                explanations[3] = "회피율 5% 증가";
                goto case 3;
            case 5:
                explanations[4] = "회피율 5% 증가";
                goto case 4;
            case 6:
                explanations[5] = "회피율 5% 증가";
                goto case 5;
            case 7:
                explanations[6] = "회피율 5% 증가";
                goto case 6;
            case 8:
                explanations[7] = "회피율 5% 증가";
                goto case 7;
            case 9:
                explanations[8] = "회피율 10% 증가";
                goto case 8;
        }
    }
}
